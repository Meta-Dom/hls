 ...
 * </p>
 * <ul>
 *   <li>{@link hu.metadom.hls.ssamodel.impl.StructImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructImpl extends TypeImpl implements Struct {
	/**
	...
	protected EClass eStaticClass() {
		return SsaModelPackage.Literals.STRUCT;
	}
	...
	public EList<StructMember> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<StructMember>(StructMember.class, this,
					SsaModelPackage.STRUCT__MEMBERS);
		}
		return members;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SsaModelPackage.STRUCT__MEMBERS:
