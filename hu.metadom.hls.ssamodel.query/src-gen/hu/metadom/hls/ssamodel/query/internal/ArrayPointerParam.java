...
public final class ArrayPointerParam extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private ArrayPointerParam() {
   ...
   * 
   */
  public static ArrayPointerParam instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link ArrayPointerParam} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ArrayPointerParam#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ArrayPointerParam INSTANCE = new ArrayPointerParam();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ArrayPointerParam.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.metadom.hls.ssamodel.query.arrayPointerParam";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find arrayPointerParamInFunction(function, param, v)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_function, var_param, var_v), ArrayPointerParamInFunction.instance().getInternalQueryRepresentation());
          // 	neg find notArrayPointerParamChain(param)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_param), NotArrayPointerParamChain.instance().getInternalQueryRepresentation());
          // 	neg find simplePointerParam(function, param, v)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_function, var_param, var_v), SimplePointerParam.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
