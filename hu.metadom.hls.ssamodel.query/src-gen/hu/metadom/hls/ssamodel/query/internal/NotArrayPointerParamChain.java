...
public final class NotArrayPointerParamChain extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private NotArrayPointerParamChain() {
   ...
   * 
   */
  public static NotArrayPointerParamChain instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link NotArrayPointerParamChain} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NotArrayPointerParamChain#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NotArrayPointerParamChain INSTANCE = new NotArrayPointerParamChain();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NotArrayPointerParamChain.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.metadom.hls.ssamodel.query.notArrayPointerParamChain";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find arrayPointerParamInFunction(_, p2, _)
          new NegativePatternCall(body, Tuples.flatTupleOf(var___0_, var_p2, var___1_), ArrayPointerParamInFunction.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
