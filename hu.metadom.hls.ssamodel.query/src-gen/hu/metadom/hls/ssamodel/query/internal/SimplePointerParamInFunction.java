...
public final class SimplePointerParamInFunction extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private SimplePointerParamInFunction() {
   ...
   * 
   */
  public static SimplePointerParamInFunction instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link SimplePointerParamInFunction} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SimplePointerParamInFunction#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SimplePointerParamInFunction INSTANCE = new SimplePointerParamInFunction();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SimplePointerParamInFunction.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.metadom.hls.ssamodel.query.simplePointerParamInFunction";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find notSimplePointerVar(v)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_v), NotSimplePointerVar.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
