...
public final class InitOrInitListOrParam extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private InitOrInitListOrParam() {
   ...
   * 
   */
  public static InitOrInitListOrParam instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link InitOrInitListOrParam} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InitOrInitListOrParam#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InitOrInitListOrParam INSTANCE = new InitOrInitListOrParam();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InitOrInitListOrParam.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.metadom.hls.ssamodel.query.initOrInitListOrParam";
    }
