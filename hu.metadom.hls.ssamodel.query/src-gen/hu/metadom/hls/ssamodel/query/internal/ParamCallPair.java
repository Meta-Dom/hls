...
public final class ParamCallPair extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private ParamCallPair() {
   ...
   * 
   */
  public static ParamCallPair instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link ParamCallPair} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ParamCallPair#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ParamCallPair INSTANCE = new ParamCallPair();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ParamCallPair.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final PParameter parameter_calledParam = new PParameter("calledParam", "hu.metadom.hls.ssamodel.SsaParam", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://hls.metadom.hu/ssaModel", "SsaParam")), PParameterDirection.INOUT);

    private final List<PParameter> parameters = Arrays.asList(parameter_param, parameter_calledParam);
    ...
    public String getFullyQualifiedName() {
      return "hu.metadom.hls.ssamodel.query.paramCallPair";
    }

    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("param","calledParam");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          PVariable var_calledParam = body.getOrCreateVariableByName("calledParam");
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_calledParam), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://hls.metadom.hu/ssaModel", "SsaParam")));
          body.setSymbolicParameters(Arrays.<ExportedParameter>asList(
             new ExportedParameter(body, var_param, parameter_param),
             new ExportedParameter(body, var_calledParam, parameter_calledParam)
          ));
          // 	SsaArgument.node(arg, param)
          ...
          new Equality(body, var__virtual_1_, var_calledParam);
          bodies.add(body);
      }
      return bodies;
    }
